...
<div class="header">
    ...
    <div class="right">
        <span class="doc-meta">
            ...
            Date: {{ $order->sale_date?->format('d/m/Y') }}<br>
            Client: {{ $order->customer?->name ?: 'Client comptoir' }}
        </span>
    </div>
</div>
<table>
...
<table class="totals">
    ...
    <tr><td>Paye</td><td class="right">{{ number_format($order->paid_amount, 2) }} MAD</td></tr>
</table>
<p class="muted">{{ $order->notes ?: $order->company->invoice_footer_text }}</p>
